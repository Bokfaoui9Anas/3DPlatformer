...
public class VariableJoystickEditor : JoystickEditor
{
    ...
    {
        base.DrawValues();
        EditorGUILayout.PropertyField(moveThreshold, new GUIContent("MoveStrategy Threshold", "The distance away from the center input has to be before the joystick begins to moveStrategy."));
